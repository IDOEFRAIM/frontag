...
export default function ClientDetailPage({ params }: PageProps) {
    // CORRECTION : Déballage de la Promise params avec le hook use()
    ...
    // Simulation du catalogue (Normalement récupéré via un service/API)
    const catalog = [
    ...
    return (
        <div className="min-h-screen bg-[#F8FAFC] p-6 lg:p-12 pb-32">
            ...
            <div className="grid grid-cols-1 xl:grid-cols-12 gap-10">
                ...
                {/* COLONNE DROITE : ACTION CENTER (TUNNEL DE VENTE) */}
