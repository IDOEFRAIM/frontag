                ...
                <div className="max-w-5xl mx-auto flex justify-between items-center">
                    ...
                    <div className="flex gap-4">
                        ...
                        <button 
                            ...
                            className="px-8 py-3 bg-gradient-to-r from-emerald-500 to-teal-600 text-white font-bold rounded-2xl shadow-lg shadow-emerald-200 hover:scale-105 active:scale-95 transition-all flex items-center gap-2"
                        >
            ...
            <main className="max-w-5xl mx-auto p-6 md:p-12">
                ...
                <div className="bg-white rounded-[3rem] shadow-xl shadow-orange-100/20 overflow-hidden border border-orange-50 mb-10">
                    <div className="flex flex-col md:flex-row">
                        {/* Image Preview */}
                        <div className="md:w-1/2 h-[400px] relative bg-[#F9F7F2] flex items-center justify-center border-r border-orange-50">
